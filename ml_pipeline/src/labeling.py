...
if __name__ == "__main__":
    ...
    input_path = os.path.join(DATA_DIR, "JOB_DATA_WITH_COMPANY.csv")
    ...
    out_all = os.path.join(DATA_DIR, "JOB_DATA_IMPROVED_LABELS.csv")
    ...
    out_hc = os.path.join(DATA_DIR, "JOB_DATA_HIGH_CONFIDENCE.csv")
